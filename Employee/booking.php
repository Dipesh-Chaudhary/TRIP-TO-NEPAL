		...
		<table>
			...
			<tr>
                ...
                <td><?php
                    ...
                    echo "<a href='http://localhost/tour and travel website/Employee/confirmBooking1.php?bookingId=$bookingId'>confirm</a>";
                    ?>
                </td>
                <td><?php
                    
                    echo "<a href='http://localhost/tour and travel website/Employee/cancelBooking.php?bookingId=$bookingId'>cancel</a>";
                    ?>
                </td>
